...
function App() {
  ...
  return (
    <>
      ...
      <Routes>
        {/* admin componests */}
      <Route path="/AdminDashboard" element={<div><Navbar userType={userType}  userId={userId}  setUserId={setUserId} propertyId={propertyId} setPropertyId={setPropertyId}/><AdminDashboard propertyId={propertyId} setPropertyId={setPropertyId}/></div>} />
